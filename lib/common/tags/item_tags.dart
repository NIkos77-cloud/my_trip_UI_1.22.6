...
typedef OnPressedCallback = void Function(TagItem i);

/// Used by [ItemTags.OnLongPressed].
typedef OnLongPressedCallback = void Function(TagItem i);
...
class ItemTags extends StatefulWidget {
  ItemTags(
      ...
      this.customData,
      this.textStyle = const TextStyle(fontFamily: "Proxima Nova",fontSize: 14),
...
///callback
class TagItem {
  TagItem({this.index, this.title, this.active, this.customData});
  final int index;
  final String title;
  final bool active;
  final dynamic customData;
