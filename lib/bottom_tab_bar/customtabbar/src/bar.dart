...
class ConvexAppBarState extends State<ConvexAppBar>
  ...
  Widget build(BuildContext context) {
    ...
    // wid ? math.max(MediaQuery.of(context).padding.bottom, 20.0) :
        math.max(MediaQuery.of(context).padding.bottom, 26.0);
    final convexIndex = isFixed() ? (widget.count ~/ 2) : _currentIndex;
    final active = isFixed() ? convexIndex == _currentIndex : true;

    final height = wid ? 84.0 : widget.height ?? BAR_HEIGHT + additionalBottomPadding;
  ...
  Widget _barContent(double height, double paddingBottom, int curveTabIndex) {
      ...
      children.add(Expanded(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            // Colors.grey
            Color.fromRGBO(244, 237, 252, 100) 
            : Colors.transparent,
          ...
          child: GestureDetector(
            ...
            child:
            i == 0 ? Image.asset('assets/images/home_tab.png',color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),):
            
            // Icon(Icons.home,size: 30,color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),) :
            i == 1 ? Image.asset('assets/images/profile_tab.png',color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),):
            //  Icon(Icons.person_outline,size: 30,color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),) :
            i == 3 ? Image.asset('assets/images/explore_tab.png',color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),):
            // Icon(Icons.accessibility_new,size: 30,color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),) :
            i == 4 ? 
            Image.asset('assets/images/support_tab.png',color: _currentIndex == i ? Color.fromRGBO(134, 18, 234, 1) : Color.fromRGBO(66, 67, 106, 1),):
            Container(),
            // _newTab(i, active),
            onTap: () => _onTabClick(i),
          ),
    ...
    return Container(
      height: height,
      // color: Colors.grey,
      padding: EdgeInsets.only(bottom: 0,top: 0.0),
      child:
       Row(
