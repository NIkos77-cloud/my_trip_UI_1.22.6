...
class Data {
  ...
  static const badges = [
    null,
    Badge('1'),
    Badge('hot', badgeColor: Colors.orange, padding: EdgeInsets.only(left: 7, right: 7)),
  ...
  static List<TabItem> items({bool image}) {
    if (image) {
      return [
        ...
        TabItem<Image>(
            icon: Image.asset('images/sample-2.png'), activeIcon: Image.asset('images/sample-2-2.png'), title: 'New'),
        TabItem<Image>(
